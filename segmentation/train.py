...
def main_worker(save_models_dir, save_logs_dir, args):
    ...
    if local_rank == 0:
        print(f"Training {args.network_name}")
    ...
    for epoch in range(max_epochs):
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                savepath = os.path.join(save_models_dir, "model_ep="+ pad_zeros_at_front(epoch+1, 4) +".pth")
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--input-patch-size', type=int, default=64, metavar='inputsize',
                        help='size of cropped input patch for training (default:  64)')
    parser.add_argument('--inference-patch-size', type=int, default=128, metavar='infsize',
                        help='size of cropped input patch for inference (default: 128)')
